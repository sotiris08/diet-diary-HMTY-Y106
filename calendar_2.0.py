...
class MyApp() :
    ...
    def profile_button(self) :
        self.button = tk.Button(self.f1 , text = 'profile' , font = 'Arial 10' , bg = 'black' , fg = 'white' , width = 10 , height = 10 )
        self.button.pack(padx = '20' , side = 'right')
        
    def create_calendar(self):
        self.cal = Calendar(self.f1, selectmode = 'day')
        self.cal.pack(pady = "50" , side = 'left')
    ...
    def save_in_file(self) :
        ...
        self.all_dates()
        f = open('all_dates.txt' , 'r' ,  encoding='utf-8')
    ...
    def show_meals(self) :
        ...
        f = open(str(self.day) + '-' + str(self.month) + '-' + str(self.year) + '-' + 'decatan' + '.txt' , 'r' ,  encoding='utf-8')
        self.decatan_meals = tk.Label(self.fr2 , text = str(f.read()))
        f.close()
        self.decatan_meals.pack()
        f = open(str(self.day) + '-' + str(self.month) + '-' + str(self.year) + '-' + 'lunch' + '.txt' , 'r' ,  encoding='utf-8')
        self.lunch_meals = tk.Label(self.fr3 , text = str(f.read()))
        f.close()
        self.lunch_meals.pack()
        f = open(str(self.day) + '-' + str(self.month) + '-' + str(self.year) + '-' + 'evening' + '.txt' , 'r' ,  encoding='utf-8')
        self.evening_meals = tk.Label(self.fr4 , text = str(f.read()))
        f.close()
        self.evening_meals.pack()
        f = open(str(self.day) + '-' + str(self.month) + '-' + str(self.year) + '-' + 'diner' + '.txt' , 'r' ,  encoding='utf-8')
